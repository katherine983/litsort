...
entries=[]
errorlog=[]
df=pd.read_excel('complexity_searches_2022/article_export_2023.01.02.xlsx', sheet_name='Sheet2', header=0)
...
df_complexity.to_csv('article_export_complexity_2023.csv', sep='\t')
print("")
